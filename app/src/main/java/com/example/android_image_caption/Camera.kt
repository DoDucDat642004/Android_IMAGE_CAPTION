...
/**
 * Lớp `Camera` : mở camera, hiển thị preview, chụp ảnh và gửi ảnh đi xử lý.
...
class Camera(
    ...
    /**
     * Hiển thị preview camera trên TextureView.
    ...
    private fun bitmapToByteArray(bitmap: Bitmap): ByteArray {
        ...
        bitmap.compress(Bitmap.CompressFormat.JPEG, 100, outputStream) // Nén ảnh
