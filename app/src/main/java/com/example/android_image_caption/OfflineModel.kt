...
/**
 * Lớp `OfflineModel` : tải, lưu trữ và thực thi mô hình AI (PyTorch) trên thiết bị.
...
class OfflineModel(private val context: Context, private val listener: IModel) {
    ...
    /**
     * Kiểm tra và đảm bảo mô hình tồn tại trong bộ nhớ.
     * Nếu chưa có, sao chép mô hình từ `assets` vào bộ nhớ.
     */
    @SuppressLint("UseKtx")
